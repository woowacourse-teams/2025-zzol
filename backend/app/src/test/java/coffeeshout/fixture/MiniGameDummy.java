...
public class MiniGameDummy implements Playable {
    ...
    public Map<Gamer, MiniGameScore> getScores() {
        ...
        scores.put(PlayerFixture.호스트꾹이().toGamer(), new CardGameScore(20));
        scores.put(PlayerFixture.게스트루키().toGamer(), new CardGameScore(-10));
        return scores;
    }
    ...
    @Override
    public void setUp(List<Gamer> players) {
    }
