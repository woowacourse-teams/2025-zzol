...
class WsRecoveryControllerTest extends RoomWebSocketTestSupport {
    ...
    void tearDown() {
        ...
        wsRecoveryService.cleanup(TEST_JOIN_CODE);
    }
    ...
    void 웹소켓이_연결된_상태에서_복구_요청_시_메시지를_반환한다() throws Exception {
        ...
        String savedStreamId = wsRecoveryService.save(TEST_JOIN_CODE, TEST_DESTINATION, response);
