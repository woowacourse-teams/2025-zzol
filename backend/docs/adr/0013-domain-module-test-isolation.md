...
경합"으로 지목했으나, 그 판정은 잘못이었다. #1402 비활성화 시점(06-11)에 이미 트리에
있던 #1361/#1369 와 달리, **이후 머지된 #1411(게임 통합테스트 subscribe 등록 완료 대기,
타이밍 결함)** 이 실제 결함을 해소했다. 즉 플레이키의 원인은 reuse(공유 컨테이너)가 아니라 구독 등록과 메시지
발행 사이의 타이밍이었다.
