...
| [0002](adr/0002-number-poker-game-design.md) | 넘버포커 게임 설계 | 승인 | `numberpoker/`, `room/domain/roulette/` | 플레이어 vs 딜러 개인전, Playable 미구현 독립 구조, 1% 확률 하한선 보장, PokerPhase는 NumberPokerGame 보유 |
