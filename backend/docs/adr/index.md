...
| [0010](0010-stomp-session-manager-redis.md) | StompSessionManager — 인메모리에서 Redis 기반으로 전환 | 승인 | `global/websocket/`, `global/websocket/infra/`, `global/websocket/event/` | 세션 조회·등록은 반드시 Redis 경유, 로컬 인메모리 맵 사용 금지 |
