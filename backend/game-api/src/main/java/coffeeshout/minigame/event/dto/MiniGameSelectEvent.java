...
public record MiniGameSelectEvent(
    ...
    public MiniGameSelectEvent(
            String joinCode, String hostName, List<MiniGameType> miniGameTypes, String principalName) {
        this(UUID.randomUUID().toString(), Instant.now(), joinCode, hostName, miniGameTypes, principalName);
    }
}
