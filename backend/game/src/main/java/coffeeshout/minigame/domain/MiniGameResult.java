...
public class MiniGameResult {
    ...
    public static MiniGameResult fromDescending(@NonNull Map<PlayerView, MiniGameScore> playerScores) {
        return of(playerScores, Comparator.reverseOrder());
    }

    public static MiniGameResult fromAscending(@NonNull Map<PlayerView, MiniGameScore> playerScores) {
        return of(playerScores, Comparator.naturalOrder());
    }

    public static MiniGameResult of(
            @NonNull Map<PlayerView, MiniGameScore> playerScores,
