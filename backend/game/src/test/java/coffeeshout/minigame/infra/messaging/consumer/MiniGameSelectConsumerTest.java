...
class MiniGameSelectConsumerTest {
    ...
    class Accept {
        ...
        void 세션을_갱신한_뒤_이벤트를_재발행한다() {
            // given
            final MiniGameSelectEvent event = new MiniGameSelectEvent("ABCD", "꾹이", List.of(MiniGameType.CARD_GAME));
        ...
        void 세션_갱신이_실패하면_실패_이벤트를_발행한다() {
            ...
            final MiniGameSelectEvent event =
                    new MiniGameSelectEvent("ABCD", "비호스트", List.of(MiniGameType.CARD_GAME), "ABCD:비호스트");
