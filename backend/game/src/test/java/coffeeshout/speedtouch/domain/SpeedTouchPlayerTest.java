...
class SpeedTouchPlayerTest {
    ...
    class 터치_처리 {
        ...
        void 올바른_번호를_터치하면_true를_반환한다() {
            // given
            final SpeedTouchPlayer player =
                    new SpeedTouchPlayer(PlayerFixture.게스트한스().toGamer());
    ...
    class 완주시간_계산 {
        ...
        void 완주하지_않은_플레이어의_소요시간_계산은_예외가_발생한다() {
            ...
            assertCoffeeShoutException(
                    () -> player.calculateFinishMillis(startTime), GlobalErrorCode.INTERNAL_SERVER_ERROR);
        }
    }
}
