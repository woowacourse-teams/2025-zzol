...
class ProfanityAuditBatchServiceTest {
    ...
    private ProfanityAuditBatchService processor;
    ...
    void setUp() {
        ...
        final NicknameAuditProperties properties =
                new NicknameAuditProperties("test-key", "gemini-test", 0.85, 10, 20, 2);
        processor = new ProfanityAuditBatchService(
                auditRepository,
                nicknameAuditor,
