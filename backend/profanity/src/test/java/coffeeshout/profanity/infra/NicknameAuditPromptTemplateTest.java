...
class NicknameAuditPromptTemplateTest {
    ...
    private NicknameFeedback blockedFeedback(String nickname) {
        return new NicknameFeedback(nickname, AiConfidence.of(0.95), NicknameFeedback.OperatorDecision.BLOCKED, null);
    }

    private NicknameFeedback allowedFeedback(String nickname) {
        return new NicknameFeedback(nickname, AiConfidence.UNKNOWN, NicknameFeedback.OperatorDecision.ALLOWED, null);
    }
}
