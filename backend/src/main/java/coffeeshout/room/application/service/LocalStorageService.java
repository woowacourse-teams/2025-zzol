...
public class LocalStorageService implements StorageService {
    ...
    public String upload(String contents, byte[] data) {
        try {
            ...
            throw new InfrastructureException(RoomErrorCode.QR_CODE_UPLOAD_FAILED, "로컬 QR 코드 업로드에 실패했습니다.");
        }
    }
    ...
    public String getUrl(String storageKey) {
        try {
            ...
            throw new InfrastructureException(RoomErrorCode.QR_CODE_URL_SIGNING_FAILED, "로컬 QR 코드 URL 생성에 실패했습니다.");
        }
    }
}
