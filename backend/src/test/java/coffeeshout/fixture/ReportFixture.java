...
public final class ReportFixture {
    ...
    public static ReportEntity 버그_카드게임_신고() {
        return ReportEntity.createBugReport(MiniGameType.CARD_GAME, "ABC12", "카드게임이 멈춰요.", Instant.now());
    }

    public static ReportEntity 건의사항() {
        return ReportEntity.createGeneralReport(ReportCategory.SUGGESTION, "새 게임을 추가해주세요.", Instant.now());
    }
}
