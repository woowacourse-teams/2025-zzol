...
class RouletteResultJpaPersistenceTest extends ServiceTest {

    @Autowired
    private RouletteResultPersistence rouletteResultPersistence;
    ...
    class 방_상태_룰렛으로_변경 {
        ...
        void 방_상태가_ROULETTE로_변경된다() {
            ...
            // when
            rouletteResultPersistence.updateRoomStatusToRoulette("ABCD");
    ...
    class 방_종료_및_룰렛_결과_저장 {
        ...
        void 방_상태가_DONE으로_변경되고_룰렛_결과가_저장된다() {
            ...
            // when
            rouletteResultPersistence.finishRoomAndSaveResult("ABCD", winner);
