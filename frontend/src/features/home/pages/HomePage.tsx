    ...
    <Layout>
      <S.VisuallyHidden>
        ...
        <p>
          ...
          단순한 뽑기 대신 카드 게임, 레이싱, 스피드터치, 폭탄 돌리기 등 다양한 미니게임으로
          당첨 확률을 직접 바꿀 수 있어 더 쫄깃한 경험을 제공합니다.
        </p>
        <p>
          QR코드로 친구와 함께 방에 입장하고, 미니게임 결과에 따라 룰렛 당첨 확률이 결정됩니다.
          커피 내기, 밥값 내기, 업무 당번 정하기 등 무엇이든 공정하고 재미있게 결정할 수 있습니다.
        </p>
      </S.VisuallyHidden>
